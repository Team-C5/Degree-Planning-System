...
void DegreePlan::setReqCourses(string planName) {
	if (planName == "Computer Science") {
		coreReqs = { "WRIT 1301 Composition I", "WRIT 1302 Composition II", "MATH 2413 Calculus I", "PHYS 2325 University Physics", "PHYS 2326 University Physics",
					 ...
					 "PSYC 1100 Learning Frameworks", "PHYS 2125 Lab for University Physics I", "PHYS 2126 Lab for University Physics II" };
		majorReqs = { "CHEM 1311/1111 General Chemistry I and Lab", "MATH 2305 Discrete Math", "MATH 2318 Linear Algebra", "MATH 2414 Calculus II", "MATH 2320 Differential Equations", 
					  "STAT 3334 Probability and Statistics for Scientists & Engineers",
	...
	if (planName == "Chemistry") {
		coreReqs = { "WRIT 1301 Composition I", "WRIT 1302 Composition II", "MATH 2413 Calculus I", "CHEM 1311 General Chemistry I", "CHEM 1312 General Chemistry II", "HIST 1301 U.S. History I",
					 ...
					 "CHEM 1111 Lab General Chemistry I", "CHEM 1112 Lab for General Chemistry II" };
		majorReqs = {"WRIT 3315 Advanced Technical Writing", "PHYS 2325/2125 University Physics I & Lab",
	...
	if (planName == "Accounting") {
		coreReqs = { "WRIT 1301 Composition I", "WRIT 1302 Composition II", "MATH 1324 Finite Math", "HIST 1301 U.S. History I", "HIST 1302 U.S. History II", "POLS 2305 Federal Government", "POLS 2306 Texas Government",
					 "COMM 1315 Public Speaking", "PSYC 1100 Learning Frameworks" };
		majorReqs = {"ACCT 2301 Principles of Accounting I", "ACCT 2302 Principles of Accounting II", "BAPA 1301 Business Principles", "ECON 2301 Principles of Macroeconomics",
	...
	if (planName == "Marketing") {
		coreReqs = { "WRIT 1301 Composition I", "WRIT 1302 Composition II", "MATH 1324 Finite Math", "HIST 1301 U.S. History I", "HIST 1302 U.S. History II", "POLS 2305 Federal Government", "POLS 2306 Texas Government"
					 "COMM 1315 Public Speaking", "PSYC 1100 Learning Frameworks" };
		majorReqs = { "ACCT 2301 Principles of Accounting I", "ACCT 2302 Principles of Accounting II", "BAPA 1301 Business Foundations", "ECON 2301 Principles of Macroeconomics"
	...
	if (planName == "Psychology") {
		coreReqs = { "WRIT 1301 English Composition I", "WRIT 1302 English Composition II", "MATH 1314 College Algebra", "HIST 1301 U.S. History I", "HIST 1302 U.S. History II ", "POLS 2305 Federal Government"
					 "POLS 2306 Texas Government", "COMM 1315 Public Speaking", "PSYC 1100 Learning Frameworks" };
		majorReqs = { "WRIT 3306 Writing for the Social Sciences", "HUMN 3374   Critical Inquiry", "ANTH 3311 Contemporary Cultural Anthropology"
...
void DegreePlan::outputReqCourses() {
	cout << "------------------------CORES-------------------------\n" << endl;
	for (auto i = coreReqs.begin(); i < coreReqs.end(); i++) {
		cout << *i << endl;
	}
	cout << "\n-----------------------MAJORS-------------------------\n" << endl;
	for (auto i = majorReqs.begin(); i < majorReqs.end(); i++) {
		cout << *i << endl;
	}
}